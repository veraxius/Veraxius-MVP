/*
  ...
  - You are about to drop the column `context` on the `AimEvent` table. All the data in the column will be lost.
  - You are about to drop the column `type` on the `AimEvent` table. All the data in the column will be lost.
  - You are about to drop the column `value` on the `AimEvent` table. All the data in the column will be lost.
  - Added the required column `reason` to the `AimChallenge` table without a default value. This is not possible if the table is not empty.
  - Added the required column `severity` to the `AimChallenge` table without a default value. This is not possible if the table is not empty.
  - Added the required column `delta` to the `AimEvent` table without a default value. This is not possible if the table is not empty.
  - Added the required column `eventType` to the `AimEvent` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "DomainAimEvent" ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "domainName" SET DATA TYPE TEXT,
ALTER COLUMN "eventType" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "PostDomain" ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "domainName" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "UserDomainScore" ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "domainName" SET DATA TYPE TEXT;
